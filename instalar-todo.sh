...
validar_acceso_ui_sin_autenticacion() {
    ...
    declare -A ui_checks=(
        ...
        ["Argo_Rollouts"]="8089/:200"
        ["MinIO_API"]="8090/:200"
        ["MinIO_Console"]="8091/minio/health/live:200"
        ["K8s_Dashboard"]="8092/:200"
    )
...
mostrar_resumen_completo_uis() {
    ...
    echo ""
    echo "� Argo Rollouts Dashboard: http://localhost:8089"
    echo "   📋 Propósito: Progressive delivery y canary deployments"
    echo "   🔓 Acceso: ANÓNIMO - SIN LOGIN REQUERIDO"
