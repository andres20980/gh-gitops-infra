...
mostrar_ayuda_completa() {
    ...
    echo "  01                      Permisos y prerrequisitos"
    echo "  02                      Dependencias"
    echo "  03                      Clusters (dev, pre, pro)"
    echo "  04                      ArgoCD"
    echo "  # 05: herramientas GitOps (Gitea) se trata como dependencia externa"
    echo "  05                      Aplicaciones de ejemplo"
    echo "  06                      Finalización"
    echo ""
