...
main() {
    ...
    log_info "   3. Generar apps: ./scripts/tools/app-generator.sh"
    log_info "   4. Ver reporte: cat /tmp/gitops-final-report.txt"
    log_info ""
    log_info "📚 DOCUMENTACIÓN:"
    log_info "   - Arquitectura: docs/ARQUITECTURA_DETALLADA.md"
    log_info "   - Troubleshooting: docs/TROUBLESHOOTING.md"
    log_info "   - Contribuir: docs/CONTRIBUTING.md"
    log_info ""
